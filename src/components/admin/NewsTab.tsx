...
function validate(form: Omit<NewsItem, 'id'>): string | null {
  if (!form.title || !form.content) return 'Por favor complete los campos obligatorios.';
  return null;
}
...
export default function NewsTab({ items, onItemsChange }: TabComponentProps<NewsItem>) {
  const {
    ...
    { itemName: 'Noticia', emptyForm: EMPTY_FORM, prefix: 'n_', validate },
    items, onItemsChange
  );
      ...
      <div className="bg-white border border-gray-100 rounded-3xl p-6 sm:p-8 shadow-sm">
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="md:col-span-2">
            ...
            <input type="text" placeholder="ej. Expedición científica..." value={form.title}
          ...
          <div className="md:col-span-2">
            <ImageUploader
              ...
              label="Imagen Ilustrativa" uploadLabel="Subir imagen de noticia"
          ...
          <div className="md:col-span-2">
            ...
            <textarea rows={6} placeholder="Escriba los párrafos de la noticia..." value={form.content}
